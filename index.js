...
async function run(){
    try{
      ...
      const userAddCollection = client.db("photographer").collection("add");
      ...
      app.post("/addService", async (req, res) => {
        ...
        const result = await userAddCollection.updateOne(
          filter,
          updateDoc,
          options
        );
      ...
      app.put("/reviews/edit/:id", async (req, res) => {
        ...
        const result = await userReviewCollection.updateOne(
          filter,
          updateDoc,
          options
        );
